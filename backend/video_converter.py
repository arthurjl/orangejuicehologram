from moviepy.editor import ColorClip, CompositeVideoClip, VideoFileClip, clips_array, vfx
...
def convertVideo(filepath, percentage):
    ...
    final_clip = CompositeVideoClip([clip1.set_position(clip1_pos), 
                                    ...
                                    clip4.set_position(clip4_pos),
                                    clip5.set_position(clip5_pos).set_duration(clip1.duration),
                                    clip6.set_position(clip6_pos).set_duration(clip1.duration)], size=(width, width))
